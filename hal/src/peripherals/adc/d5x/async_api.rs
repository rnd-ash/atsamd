...
pub struct InterruptHandler<A: crate::adc::Adc> {
    _private: (),
    _adc: PhantomData<A>
}

impl<A: crate::adc::Adc> crate::typelevel::Sealed for InterruptHandler<A>{}

impl<A: crate::adc::Adc> Handler<A::Interrupt> for InterruptHandler<A> {
