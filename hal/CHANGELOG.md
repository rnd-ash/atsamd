...
## [0.23.4](https://github.com/rnd-ash/atsamd/compare/atsamd-hal-0.23.3...atsamd-hal-0.23.4) - 2026-06-01

### Added

- *(usb)* Enable Multi-Packet Rx and Tx ([#1009](https://github.com/rnd-ash/atsamd/pull/1009))

### Fixed

- *(timer)* Fix misuse of ctrlbset and ctrlbclr ([#1001](https://github.com/rnd-ash/atsamd/pull/1001))
- *(rtc)* disable compare interrupt instead of stopping the RTC counter ([#992](https://github.com/rnd-ash/atsamd/pull/992))

### Other

- Introduce more peripheral free methods for consistency ([#1000](https://github.com/rnd-ash/atsamd/pull/1000))
- Fix nightly clippy lint ([#1006](https://github.com/rnd-ash/atsamd/pull/1006))
- Update DMAC documentation ([#1005](https://github.com/rnd-ash/atsamd/pull/1005))
- Make ADC `check_read_discard` private again ([#1003](https://github.com/rnd-ash/atsamd/pull/1003))
