...
## [0.23.0](https://github.com/rnd-ash/atsamd/compare/atsamd-hal-0.22.2...atsamd-hal-0.23.0) - 2025-10-15
...
- *(ci)* silence deprecation warning we have no power over ([#943](https://github.com/rnd-ash/atsamd/pull/943))
...
- Document order of calling enable_interrupt for interrupt timer ([#942](https://github.com/rnd-ash/atsamd/pull/942))
